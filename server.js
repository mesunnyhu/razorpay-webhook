...
const OWNER_ACCOUNT_ID = "acc_YourOwnerAccount"; // ✅ Replace with real Razorpay Account ID
const PARTNER_ACCOUNT_ID = "acc_YourPartnerAccount"; // ✅ Replace with real Partner's Razorpay Account ID
